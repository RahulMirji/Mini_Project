            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <center><ul><h1 class="mt-4">College Enrollment Registration</h1></ul></center>
                            ...
                            <div class="col-xl-4 col-md-12" >
                                <div class="card bg-primary text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="signup.php">Register Here</a>
...
<div class="col-xl-4 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="admin"> Click Here</a>
